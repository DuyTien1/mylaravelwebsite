...
<body>
					...
					<div class="col-sm-8">
						<div class="mainmenu pull-right">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								?>
								<li class="dropdown"><a href="#"> {{ Session::get('customer_name') }}<i class="fa fa-angle-down"></i></a>
	...
	<section id="form"><!--form-->
		<div class="container">
			<div class="row">
                <h3 style="text-align: center;">Cảm ơn bạn đã tin dùng dịch vụ của chúng tôi đơn hàng của bạn sẽ được xử lý trong thời gian sớm nhất, trân trọng</h3>
			</div>
