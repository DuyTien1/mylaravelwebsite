	...
	<section>
		<div class="container">
			<div class="row">			
                    ...
                    <h2>Công Cụ</h2>
                        ...
                        <div class="panel-group category-products" id="accordian">					
							...
							<div class="panel-heading">
                                    <h4 style="margin-top: 10px;" class="panel-title"><a href="{{ URL::to('/account-info/'.Session::get('customer_id')) }}">Thông Tin Tài Khoản</a></h4>
                                </div>
                                <div class="panel-heading">
                                    <h4 style="margin-top: 10px;" class="panel-title"><a href="{{ URL::to('/history/'.Session::get('customer_id')) }}">Lịch Sử Mua Hàng</a></h4>
                                </div>
								<div class="panel-heading">
                                    <h4 style="margin-top: 10px;" class="panel-title"><a href="{{ URL::to('/favorite/'.Session::get('customer_id')) }}">Sản Phẩm Yêu Thích</a></h4>
                                </div>
                                <div class="panel-heading">
                                    <h4 style="margin-top: 10px;" class="panel-title"><a href="{{ URL::to('/account/'.Session::get('customer_id')) }}">Thay Đổi Mật Khẩu</a></h4>
                                </div>
                            </div>
                        </div>
						<!--/category-products-->
				...
				<div style="margin-bottom: 20px; margin-top: 10px;" class="col-sm-9 padding-right">
					@yield('content')
		        </div>
			</div>
		</div>
