...
<head>
    ...
    <title>E-ShopReal - Thông Tin Giao Hàng</title>
		...
		<section id="cart_items">
			<div class="container">
				...
				<div class="register-req">
					<p>Hãy Đăng Ký Tài Khoản và Đăng Nhập Để Xem Lại Lịch Sử Đặt hàng Của bạn</p>
				</div><!--/register-req-->
				<div class="shopper-informations">
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3">
							<div class="bill-to">
								<p style="text-align: center; width: 100%;">Thông Tin Người Đặt Hàng</p>
								<div class="form-one">
									<form action="{{ URL::to('/savecheckout') }}" method="post" class="form">
										{{ csrf_field() }}
										<label for="shipping_name">Họ Tên Người Đặt Hàng</label>
										<input style="width: 556px; margin-bottom: 1px;" type="text" name="shipping_name" value="{{ $data_customer->hoten }}" id="shipname">
										@if($errors->has('shipping_name'))
											<label style="width: 556px; height: 20px; font-size: 10px; font-weight: bold; line-height: 1px;" class="alert alert-danger">
												{{ $errors->first('shipping_name') }}
											</label>								
										@endif		
										<label for="shipping_email">Email</label>
										<input style="width: 556px; margin-bottom: 1px;" type="email" name="shipping_email" value="{{ $data_customer->email }}" id="shipemail">
										@if($errors->has('shipping_email'))
											<label style="width: 556px; height: 20px; font-size: 10px; font-weight: bold; line-height: 1px;" class="alert alert-danger">
												{{ $errors->first('shipping_email') }}
											</label>
										@endif
										<label for="shipping_add">Địa Chỉ</label>
										<input style="width: 556px; margin-bottom: 1px;" type="text" name="shipping_add" value="{{ $data_customer->diachi }}" id="shipadd">
										@if($errors->has('shipping_add'))
											<label style="width: 556px; height: 20px; font-size: 10px; font-weight: bold; line-height: 1px;" class="alert alert-danger">
												{{ $errors->first('shipping_add') }}
											</label>
										@endif
										<label for="shipping_phone">Số Điện Thoại</label>
										<input style="width: 556px; margin-bottom: 1px;" type="text" name="shipping_phone" value="{{ $data_customer->sodienthoai }}" id="shipphone">
										...
										<textarea style="width: 556px; margin-bottom: 1px;" name="shipping_note" resize="none" rows="4" id="shipnote"></textarea>
										@if($errors->has('shipping_note'))
											<label style="width: 556px; height: 20px; font-size: 10px; font-weight: bold; line-height: 1px;" class="alert alert-danger">
												{{ $errors->first('shipping_note') }}
											</label>
										@endif
										<!-- <input type="submit" value="Gửi" name="sendshipping" class="btn btn-primary btn-sm"> -->
										<p style="text-align: center; width: 556px;">
											<button style="margin: 10px; text-align: center; justify-content: center;" type="submit" class="btn btn-primary" name="addproduct">Gửi Thông Tin</button>
										</p>	
									</form>
								</div>	
							</div>
