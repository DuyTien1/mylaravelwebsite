								...
								<tbody>
									...
									<tr>
										...
										<td class="cart_quantity">
											<div class="cart_quantity_button">
												<form action="{{ URL::to('/updatecart-qty') }}" method="post">
													{{ csrf_field() }}
													<input class="cart_quantity_input" type="number" name="cart_qty" value="{{ $con_val->qty }}" style="width: 70px;" min="1" autocomplete="off" size="5">
										...
										<td class="cart_delete">
											<form action="{{ URL::to('/deletecart') }}" method="post">
												{{ csrf_field() }}
												<input type="hidden" value="{{ $con_val->rowId }}" name="rowId_cart" class="from-control">
												<input type="hidden" value="{{ $con_val->qty }}" name="incart_qty" class="from-control">
												<input type="hidden" value="{{ $con_val->id }}" name="product_id" class="from-control">
												<button class="btn btn-primary" style="margin: 0 10px 65px 0;" type="submit"><i class="fa fa-times"></i></button>
											</form>
										</td>
									</tr>
									@endforeach						
				...
				<div class="col-sm-6 col-sm-offset-3">
					<div class="total_area">
						...
						<?php
							...
							if ($customer_id != NULL) {
						?>
							<p style="text-align:center; width: 540;">
						...
						?>
							<p style="text-align:center; width: 540;">
								<a class="btn btn-default check_out" href="{{ URL::to('/checklogin') }}">Thanh Toán</a>
							</p>
						<?php
							}
						?>
